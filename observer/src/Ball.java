...
public abstract class Ball extends JComponent {
    ...
    protected MainPanel.GameStatus gameStatus = MainPanel.GameStatus.STOP;
    ...
    public abstract void notify(char keyChar);

    public abstract void checkIntersect(Ball b);

    public void notify(MainPanel.GameStatus status) {
